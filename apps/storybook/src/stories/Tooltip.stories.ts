...
import { LiquidTooltip, GlassFilterProvider } from '@liquid/ui';

const meta = {
  title: 'Components/LiquidTooltip',
  ...
  argTypes: {
    variant: {
      ...
      description: 'LiquidTooltip 樣式變體',
      table: {
    ...
    content: {
      control: 'text',
      description: 'LiquidTooltip 顯示的文字內容',
      table: {
        type: { summary: 'string' },
    ...
    placement: {
      ...
      description: 'LiquidTooltip 出現的位置',
      table: {
    ...
    disabled: {
      control: 'boolean',
      description: '是否禁用 LiquidTooltip',
      table: {
...
} satisfies Meta<typeof LiquidTooltip>;
...
export const Default: Story = {
  ...
  render: (args) => ({
    components: { LiquidTooltip, GlassFilterProvider },
    setup() {
      return { args };
    },
    template: `
      <GlassFilterProvider>
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 200px; display: flex; align-items: center; justify-content: center; gap: 2rem; border-radius: 12px; padding: 3rem;">
          <LiquidTooltip v-bind="args" content="這是提示文字">
      ...
      <GlassFilterProvider>
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 300px; display: flex; align-items: center; justify-content: center; gap: 3rem; border-radius: 12px; padding: 4rem;">
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
            ...
            <LiquidTooltip variant="default" placement="top" content="上方提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                Top
              </button>
            </LiquidTooltip>
          ...
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
            ...
            <LiquidTooltip variant="default" placement="bottom" content="下方提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                Bottom
              </button>
            </LiquidTooltip>
          ...
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
            ...
            <LiquidTooltip variant="default" placement="left" content="左側提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                Left
              </button>
            </LiquidTooltip>
          ...
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
            ...
            <LiquidTooltip variant="default" placement="right" content="右側提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                Right
              </button>
            </LiquidTooltip>
...
export const GlassCssOnly: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <GlassFilterProvider>
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 200px; display: flex; align-items: center; justify-content: center; gap: 2rem; border-radius: 12px; padding: 3rem;">
          <LiquidTooltip v-bind="args" content="玻璃效果提示">
            <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
              懸停查看提示
            </button>
          </LiquidTooltip>
    ...
    template: `
      <GlassFilterProvider>
        <div style="background: linear-gradient(135deg, #0f2027 0%, #203a43 50%, #2c5364 100%); min-height: 200px; display: flex; align-items: center; justify-content: center; gap: 2rem; border-radius: 12px; padding: 3rem;">
          <LiquidTooltip v-bind="args" content="高光玻璃提示">
            <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
              懸停查看提示
            </button>
          </LiquidTooltip>
        ...
        <div style="display: flex; flex-direction: column; gap: 2.5rem;">
          ...
          ">
            <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
              ...
              <LiquidTooltip variant="glass-css-only" placement="top" content="純 CSS 玻璃效果">
                <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                  CSS Only
                </button>
              </LiquidTooltip>
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
              ...
              <LiquidTooltip variant="glass-highlight-layered" placement="top" content="高光層疊玻璃效果">
                <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                  Highlight Layered
                </button>
              </LiquidTooltip>
          ...
          ">
            <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
              <p style="color: rgba(255,255,255,0.6); font-size: 11px; margin: 0; text-transform: uppercase; letter-spacing: 0.08em;">glass-css-only</p>
              <LiquidTooltip variant="glass-css-only" placement="top" content="深色背景玻璃">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
              <p style="color: rgba(255,255,255,0.6); font-size: 11px; margin: 0; text-transform: uppercase; letter-spacing: 0.08em;">glass-highlight-layered</p>
              <LiquidTooltip variant="glass-highlight-layered" placement="top" content="深色高光玻璃">
                <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.3); color: white; cursor: pointer;">
                  Highlight Layered
                </button>
              </LiquidTooltip>
      ...
      <GlassFilterProvider>
        ...
        ">
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
            ...
            <LiquidTooltip variant="default" placement="top" content="預設樣式提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                懸停查看提示
              </button>
            </LiquidTooltip>
          ...
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
            <p style="color: rgba(255,255,255,0.6); font-size: 11px; margin: 0; text-transform: uppercase; letter-spacing: 0.08em;">glass-css-only</p>
            <LiquidTooltip variant="glass-css-only" placement="top" content="玻璃效果提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                懸停查看提示
              </button>
            </LiquidTooltip>
          ...
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
            <p style="color: rgba(255,255,255,0.6); font-size: 11px; margin: 0; text-transform: uppercase; letter-spacing: 0.08em;">glass-highlight-layered</p>
            <LiquidTooltip variant="glass-highlight-layered" placement="top" content="高光玻璃提示">
              <button style="padding: 0.75rem 1.5rem; border-radius: 8px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; cursor: pointer;">
                懸停查看提示
              </button>
            </LiquidTooltip>
